...
import { getRecipeByRecipeID, getallRecipeByUserID } from "@/context/recipe/recipeSlice";
import Link from "next/link";
import ImagePlaceholder from "@/components/ImagePlaceholder";
import { getallDrinks } from "@/context/recipe/drinkSlice";
...
const Profile = () => {
	...
	const getUserdrinks = useSelector((state) => state?.drinkSlice)
	...
	useEffect(() => {
		if(userProfileData?.id){
			dispatch(getallDrinks(userProfileData?.id))
		}
	...
	const handlePageDetail = async (recipe_id) => {
		...
		window.location.href = `/Recipe2/${recipe_id}`
		// window.location.href = `/Drink_recipe.js${drink_id}`
		// try {
						...
						<div className="full-page-fullbar-profile">
							...
							<div>
								<Row>
									...
									<Col lg={2} sm={3} xs={3}>
										<p>
											<a className="active" href="#"> <img src="images/NewProject.png" />{" "}</a>
										</p>
									</Col>
									<Col lg={2} sm={3} xs={3}>
										<p>
											<a className="active" href="#"><img src="images/NewProject1.png" /></a>
										</p>
									</Col>
									<Col lg={2} sm={3} xs={3}>
										<p>
									...
									<Row>
									<Col lg={3} sm={3} xs={3}>
										<div className="add_drinks">
											<Link className="active" href="/Create_Recipes"> Add recipe</Link>
										</div>
									</Col>
									<Col lg={3} sm={3} xs={3}>
										<div className="add_drinks">
											<Link className="active" href="/AddDrink">Add drinks</Link>
										</div>
									</Col>
									<Col lg={3} sm={3} xs={3}>
										<div className="add_drinks">
											<Link className="active" href="/AddSeasoning">Add Seasoning</Link>
										</div>
									</Col>
									<Col lg={3} sm={3} xs={3}>
										<div className="add_drinks">
											<Link className="active" href="/AddSauce">Add Sauce</Link>
										</div>
									</Col>
								</Row>
								...
								<div>
									...
									{/* <Row> */}
										{/* <Col lg={4}> */}
							    <h2 className="text-center my-3 ">Recipe</h2>
								<div className="row">
								{userRecipe?.map((recipe, index) => (
									<div key={index} className="col-sm-6 col-md-4" onClick={() => handlePageDetail(recipe.id)}>
