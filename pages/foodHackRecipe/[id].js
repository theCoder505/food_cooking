...
import { getFoodHackByFoodHackID } from "@/context/recipe/foodhackSlice";

const foodHackRecipe = () => {
  ...
  const getrecipe = useSelector((state) => state?.foodHackSlice?.foodhackbyid?.result);

  const dispatch = useDispatch();
  useEffect(() => {
    if (id) {
      dispatch(getFoodHackByFoodHackID(id))
    }
  }, [id])
                  ...
                  <div className="Shrimp_list">
                    <ul>
                      ...
                      <li>
                        {/* <strong>3/8</strong>{" "} */}
                        <strong>
                          {data?.substitues === "undefined"
                            ? "0"
                            : data?.substitues?.length}
                        </strong>{" "}
                        <span>
              ...
              <div className="col-md-9">
                ...
                <div className="row mt-3">
                  <div className="col-md-3">
                    <div className="col-Options">
                      <span>
                        <img className="icon2" src="/images/Mask group kit.png" /></span>
                      <h4> <img className="ms-2" src="/images/Vector.png" />  Tools & Equipment's <img className="" src="/images/Vector 1.png" /></h4>
                      <span>
                        <h4>  <img className="ms-5" src="/images/Vector (3).png" />   Needed    <img className="" src="/images/Vector (2).png" /></h4>
                      </span>
                  ...
                  <div className="tab-content" id="myTabContent">
                    ...
                    >
                      <div className="Ingredients-tab">
                        <h3>-Ingredients-</h3>
                        {data?.ingredients?.id?.recipe_id?.title}
                        <strong>
                          ...
                          <table>
                            <tbody>
                              <tr>
                                ...
                                <td>
                                  Shallots <br /> Red Onion <br /> Sweet Onion
                                </td>
                              </tr>
                              ...
                              <tr className="blacktr">
                                ...
                                <td>
                                  Apple Cider Vinegar <br /> Champagne Vinegar{" "}
                                  <br /> White Wine Vinegar <br /> Lemon/Lime
                                  juice <br /> White Balsamic Vinegar <br />{" "}
                              ...
                              <tr>
                                ...
                                <td>
                                  Grapeseed Oil <br /> Canola Oil <br />{" "}
                                  Sunflower Oil
                                </td>
                              </tr>
                            </tbody>
