            ...
            <div className="page_fliter_width">
              <div className="page_fliter_search">
                <div className="page_fliter_select">
                  <select>
                    <option>Cultural/Country</option>
                  </select>
                </div>
          ...
          {showFirstDiv ? (
            <div>
              ...
              <div className="full-page-fullbar">
                <div className="full-page-member page-drink country-pop">
                  <div className="row">
                        ...
                        <a href="Barista.html">
                          <div className="full-page-food">
                            ...
                            <div className="full-page-front">
                              <h3 className="orange">Americas</h3>
                              <ul>
                                <li>
                                  N.America - The United States, Canada, Mexico
                                </li>
                                <li>
                                  C.America - Panama, Belize, Costa Rica,
                                  Nicaraggua, Honduras, Etc
                                </li>
                                <li>-Latin America/Caribbean/West indies-</li>
                                <li>
                                  Haiti, Jamaica, Dominican Republic, Puerto
                                  Rico, Bahamas, Cuba, Etc
                                </li>
                                <li>
                                  S.America - Brazil, Argentina, Columbia, Peru,
                                  Chile, Ecuador,
                                </li>
                                <li>Venezuela, Etc</li>
                              </ul>
