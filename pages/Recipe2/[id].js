...
const Recipe2 = () => {
  ...
  const getrecipe = useSelector((state) => state?.recipeSlice?.recipebyid?.result);
                ...
                <div className="row mt-3">
                  <div className="col-md-3">
                    <div className="col-Options">
                      ...
                      <h4> <img className="ms-2" src="/images/Vector (3).png" />  Tools & Equipment's <img className="" src="/images/Vector 1.png" /></h4>
                      <span>
