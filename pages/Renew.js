    ...
    <Layout>
      ...
      <div className="main_width">
        <div className="container">
          <div className="plannercat">
            ...
            <ul>
              ...
              <li>
                <span></span>Verified Accounts Level 1.0
              ...
              <li>
                <span className="orgs"></span>Unlimited access to recipes
              </li>
              <li>
              ...
              <div className="col-Choose">
                ...
                <div className="col-Choose-paln">
                  ...
                  <div className="col-Choose-palnMonthly col-Choose-palnMonthly2">
                    ...
                    <h4>29.99!</h4>
                    <strong>
                      Renews automatically for $29.99/
                      <br />
            ...
            <div className="col-sm-12">
              <div className="col-Chooseround2">
                <div className="col-Chooseround">
                  ...
                  <h4>55.99</h4>
                  <h5>
                    Billed as $55.99 at time of order.
                    <br />
                    Renews automatically for $55.99/
                    <br />
                    year. Cancel anytime.
                  </h5>
                  <button data-bs-toggle="modal" data-bs-target="#login">
        ...
        <div className="GoldRibbon">
          <p>
            View <span>Gold Ribbon</span> High Level Verification, For
            Professionals, Businesses, High Level Content Creators And Cooking
            Shows With Additional Features
          </p>
