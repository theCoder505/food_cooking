...
import { getLabCareByDrinkID } from "@/context/recipe/labCareSlice";
...
const Drink_Recipe = () => {
  ...
  const getLabCare = useSelector((state) => state);
  // console.log(getrecipe)

  const dispatch = useDispatch();
  useEffect(() => {
    if (id) {
      dispatch(getLabCareByDrinkID(id, "labcare"))
    }
  }, [id])
